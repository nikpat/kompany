...
<div id="content" class="white">
    <h1><img src="<?php echo base_url();?>resources/images/icons/dashboard.png" alt="" /> Dashboard
        </h1>
    ...
    <div class="content dashboard">
        <div class="center">
            <a href="#" class="shortcut">
                <img src="<?php echo base_url();?>resources/images/page.png" alt="" width="48" height="48"/>
                Write an Article
            </a>
            <a href="#" class="shortcut">
                <img src="<?php echo base_url();?>resources/images/picture.png" alt="" width="48" height="48" />
                Write an Article
            </a>
            <a href="#" class="shortcut">
                <img src="<?php echo base_url();?>resources/images/contact.png" alt="" width="48" height="48" />
                Manage contacts
            </a>
            <a href="#" class="shortcut last">
                <img src="<?php echo base_url();?>resources/images/event.png" alt="" width="48" height="48" />
                Manage events
            </a>
            <div class="cb"></div>
        </div>
